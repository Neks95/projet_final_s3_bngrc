...
<head>
    ...
    <title>Modifier une Ville - BNGRC</title>
...
<body>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <!-- Page Title -->
            <div class="mb-4">
                <h1 class="display-5 fw-bold text-primary-custom">Modifier une Ville</h1>
                <p class="text-muted">Mettre à jour les informations de la ville</p>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="form-container">
                        <form id="editVilleForm" onsubmit="handleEditForm(event, 'ville')">
                            <div class="mb-3">
                                <label for="nom_ville" class="form-label">
                                    Nom de la Ville <span class="text-danger">*</span>
                                </label>
                                <input type="text" class="form-control" id="nom_ville" name="nom_ville" required value="Toamasina">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="region" name="region" required>
                                    ...
                                    <option value="Atsinanana" selected>Atsinanana</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="nb_sinistres" name="nb_sinistres" required min="1" value="5200">
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3">Ville portuaire fortement touchée par le cyclone. Infrastructures endommagées.</textarea>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="card shadow-custom">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <strong>Date de création :</strong> 10/02/2026
                            </p>
                            <p class="card-text">
                                <strong>Dernière modification :</strong> 14/02/2026
                            </p>
                            <p class="card-text">
                    ...
                    <div class="card shadow-custom mt-3">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Les modifications seront prises en compte immédiatement dans tous les rapports et statistiques.
                            </p>
                        </div>
                    </div>
                </div>
